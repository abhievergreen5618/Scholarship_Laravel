                    ...
                    <table id="ctl00_ContentPlaceHolder1_Table1" class="table Eng_hindi_form mobile_form" width="100%" border="0" cellspacing="5" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="colon">:</td>
                                <td>
                                    <span id="Anthem_ctl00_ContentPlaceHolder1_txtDob__"><input type="date" value='@if(!empty(auth()->user()->step1_updated_at)) {{(auth()->user()->dob)->format("mm-dd-Y")}} @endif' id="dob" name="dob" class="form-control">
                                </td>
                            </tr>
                            <tr>
