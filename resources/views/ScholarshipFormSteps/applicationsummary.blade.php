                                            ...
                                            <table id="ctl00_ContentPlaceHolder1_Table1" class="table Eng_hindi_form mobile_form" width="100%" border="0" cellspacing="5" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr id="ctl00_ContentPlaceHolder1_trExamCenter">
                                                        ...
                                                        <td class="colon">:</td>
                                                        <td>
                                                            &nbsp;<span id="Anthem_ctl00_ContentPlaceHolder1_lblExamCname__"><span id="ctl00_ContentPlaceHolder1_lblExamCname">{{(!empty(auth()->user()->step2_updated_at)) ? auth()->user()->mothername : ''}}</span></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
