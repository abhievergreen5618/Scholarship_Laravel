    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('admin.district.add')}}" class="nav-link active">
                <i class="fas fa-plus nav-icon"></i>
                <p>Add District</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('admin.venue.add')}}" class="nav-link active">
                <i class="fas fa-plus nav-icon"></i>
                <p>Add Exam Venue</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{route('admin.venue.index')}}" class="nav-link">
                <i class="fas fa-list nav-icon"></i>
                <p>View All Exam Venues</p>
              </a>
            </li>
          </ul>
        </li>
