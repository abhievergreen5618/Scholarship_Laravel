    ...
    <div class="typography">
        <div class="tab-content">
            <div class="tab-pane active" id="tab_5">
                <h3><span>Step [5/6] :</span>Payment &nbsp; <span id="Anthem_ctl00_ContentPlaceHolder1_lblPageMsg__"><span id="ctl00_ContentPlaceHolder1_lblPageMsg" style="color:Red;"></span></span></h3>
