                ...
                <div class="col-md-12 my-2">
                    <table id="pdf" class="widthhh">
                        ...
                        <tr>
                            ...
                            <td>
                                <span id="Anthem_ctl00_ContentPlaceHolder1_lblCoursName__"><span id="ctl00_ContentPlaceHolder1_lblCoursName"><b>{{(!empty(auth()->user()->step5_updated_at)) ? auth()->user()->transaction_id : ''}}</b></span></span>
                            </td>
                        </tr>
                        <tr>
                            <td id="pdfdata" colspan="3"></td>
                        ...
                        <tr>
                            <td width="42%" class="vtext"><strong>Amount</strong>
                            </td>
                            <td>
                                <span id="Anthem_ctl00_ContentPlaceHolder1_lblCoursName__"><span id="ctl00_ContentPlaceHolder1_lblCoursName"><b>{{(!empty(auth()->user()->step5_updated_at)) ? auth()->user()->amount : ''}}</b></span></span>
                            </td>
                        </tr>
                        <tr>
                            <td id="pdfdata" colspan="3"></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span id="Anthem_ctl00_ContentPlaceHolder1_lblCoursName__"><span id="ctl00_ContentPlaceHolder1_lblCoursName"><b>{{(!empty(auth()->user()->step5_updated_at)) ? auth()->user()->name : ''}}</b></span></span>
                            </td>
                        </tr>
                        <tr>
                            <td id="pdfdata" colspan="3"></td>
