            ...
            <div class="col-md-10">
                <div class="page">
                    ...
                    <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
                        ...
                        <label for="tab3"><i class="fas fa-hand-point-right"></i>Application Summary @if(empty(auth()->user()->step3_updated_at) || !empty(auth()->user()->3_updated_at)) <i class="fa fa-lock" aria-hidden="true"></i> @endif
                        </label>
