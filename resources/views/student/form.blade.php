            ...
            <div class="col-md-10">
                <div class="page">
                    ...
                    <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
                        ...
                        <input type="radio" name="pcss3t" id="tabb3" class="{{!empty(auth()->user()->step3_updated_at) ? 'disabled' : ''}}tab-content-third" {{empty(auth()->user()->step1_updated_at) ? 'checked' : ''}} {{!empty(auth()->user()->step3_updated_at) ? 'disabled' : ''}}>
                        <label for="tabb3"><i class="fas fa-hand-point-right"></i>Bank Details @if(!empty(auth()->user()->step3_updated_at)) <i class="fa fa-lock" aria-hidden="true"></i> @endif
                        </label>
