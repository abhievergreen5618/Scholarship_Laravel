            ...
            <div class="col-md-10">
                <div class="page">
                    ...
                    <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
                        ...
                        <input type="radio" name="pcss3t" id="tab3" class="tab-content-3" {{!empty(auth()->user()->step3_updated_at) && empty(auth()->user()->step3_updated_at) ? 'checked' : ''}} {{empty(auth()->user()->step3_updated_at) || !empty(auth()->user()->step3_updated_at) ? 'disabled' : ''}}>
