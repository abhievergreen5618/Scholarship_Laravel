            ...
            <div class="col-md-10">
                <div class="page">
                    ...
                    <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
                        ...
                        <input type="radio" name="pcss3t" id="tab2" class="tab-content-2" {{!empty(auth()->user()->step1_updated_at) && empty(auth()->user()->step2_updated_at) ? 'checked' : ''}} {{empty(auth()->user()->step1_updated_at) || !empty(auth()->user()->step3_updated_at)? 'disabled' : ''}}>
                        <label for="tab2"><i class="fas fa-hand-point-right"></i>Banking Details @if(empty(auth()->user()->step1_updated_at) || !empty(auth()->user()->step3_updated_at)) <i class="fa fa-lock" aria-hidden="true"></i> @endif
                        </label>
