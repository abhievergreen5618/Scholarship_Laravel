            ...
            <div class="card-body">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('class') {{ 'is-invalid' }} @enderror" name="classes[]" id="class" multiple="multiple" data-placeholder="Select Classes" data-dropdown-css-class="select2-purple" value="{{@old('name',$data->classes)}}">
