...
statetable.on("click", ".admitcardtimedate", function () {
    ...
    setExamDate(stateid,examdate,examstarttime,examendtime,url,"state"); 
});
...
districttable.on("click", ".admitcardtimedate", function () {
    $(".dataTables_processing").show();
    element = $(this);
    ...
    var examendtime = $(this).attr("data-examendtime");
    var url = $(this).attr("data-url");
    setExamDate(districtid,examdate,examstarttime,examendtime,url,"district"); 
});
